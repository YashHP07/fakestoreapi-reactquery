...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 w-full bg-gradient-to-r from-blue-600 to-blue-400 p-4 flex justify-between items-center shadow-lg transform transition-transform duration-300 hover:scale-105 z-50">
